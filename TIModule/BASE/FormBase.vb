...
Public Class FormBase
    Public MyForm As SAPbouiCOM.Form
    Public MyApplication As SAPbouiCOM.Application
    Public MyCompany As SAPbobsCOM.Company
    Public Tag As Object()
    Public ls198FromID As String
    Public myDataTable As SAPbouiCOM.DataTable
    Public isPermission As String
    Public MyTableName As String
    Public MyMtext As String
    ...
    Public Sub HandleMenuEvent(ByVal pVal As SAPbouiCOM.IMenuEvent, ByRef BubbleEvent As Boolean)
    ...
    Public Sub HandlePrintEvent(ByRef eventInfo As SAPbouiCOM.PrintEventInfo, ByRef BubbleEvent As Boolean)
